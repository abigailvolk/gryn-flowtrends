...
current_yr_Daily <- readNWISDaily(siteID,"00060", current_yr_start,"", verbose = F)
current_yr_Daily$cfs_2023 <- current_yr_Daily$Q*35.314666212661
...
historical_stats %>% ggplot(aes(x=Day)) +
  ...
  geom_line(aes(y=cfs_2023, color="Current Year" , lty="Current Year"), lwd=1) +
  ...
  scale_color_manual(name = "Legend", 
                     values = c("Mean" = "black", "Current Year" = "blue", "25th Percentile" = "gray", "75th Percentile" = "gray60")) +
  scale_linetype_manual(name = "Legend",
                        values = c("Mean" = 6, "Current Year" = 1, "25th Percentile" = 2, "75th Percentile" = 2))
```
...
theil_sen <- senth(peakFlow$Year, peakFlow$Day, site = site, Xlab = "Year", Ylab = "Days Since January 1st", legend_loc = "topright")
```
...
---
title: "`r SpecificGageInfo$siteName`"
